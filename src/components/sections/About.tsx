        ...
        <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              {contentLabels.about.stats.map((stat, index) => {
                const IconComponent = { Users, Briefcase, TrendingUp }[stat.icon] || Users;
                return (
                  <StatCard
                    key={index}
                    icon={<IconComponent />}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-lg font-bold text-slate-900 mb-4">{contentLabels.about.highlights.heading}</h3>
              <ul className="space-y-3">
                {contentLabels.about.highlights.items.map((highlight, index) => (
