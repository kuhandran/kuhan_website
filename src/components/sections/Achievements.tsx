        ...
        <div className="max-w-6xl mx-auto mt-12">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {Array.isArray(achievementsData.awards) && achievementsData.awards.length > 0 ? (
                achievementsData.awards.map((award: Award, index: number) => (
                  <Card 
                    key={index}
                    className="p-6 bg-linear-to-br from-amber-50 to-orange-50 border-t-4 border-t-amber-500 hover:shadow-xl transition-all duration-300 group cursor-default"
                  >
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {Array.isArray(achievementsData.certifications) && achievementsData.certifications.length > 0 ? (
                achievementsData.certifications.map((cert: Certification, index: number) => (
                  <Card 
                    key={index}
                    className="p-6 bg-linear-to-br from-blue-50 to-cyan-50 border-l-4 border-l-blue-500 hover:shadow-xl transition-all duration-300 group cursor-default"
                  >
