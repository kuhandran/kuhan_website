 ...
 * Displays privacy consent for analytics tracking
 * - Respects user choice with cookies
      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-3 whitespace-nowrap">
          <button
            ...
            className="px-4 py-2 text-sm border border-slate-600 rounded hover:bg-slate-800 transition-colors"
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-blue-600 rounded hover:bg-blue-700 transition-colors font-semibold"
