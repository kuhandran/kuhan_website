...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: [
      { url: '/files/apple-touch-icon.svg', type: 'image/svg+xml' }
    ],
  },
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth">
      <head>
        ...
        <link rel="apple-touch-icon" href="/files/apple-touch-icon.svg" type="image/svg+xml" />
